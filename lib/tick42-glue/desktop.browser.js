(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var GDExecutor = (function () {
        ...
        GDExecutor.prototype.download = function (resultWindow, url, options) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4, this.execute("downloadURL", { windowId: resultWindow.id, options: { url: url, options: options } })];
                        case 1:
                            result = _a.sent();
                            return [2, {
                                    url: url,
                                    path: result.fullPath,
                                    size: result.filleSize,
                                }];
                    }
                });
            });
    ...
    var T42DisplayOnEvent = "T42.Displays.OnEvent";
    var DisplayManager = (function () {
        ...
        DisplayManager.prototype.onDisplayChanged = function (cb) {
            this.register();
            return this._registry.add("on-display-changed", cb);
        };
        DisplayManager.prototype.register = function () {
            var _this = this;
            if (this._registered) {
                return;
            }
            this._registered = true;
            this._agm.register(T42DisplayOnEvent, function (args, caller) {
                var event = args.event;
                var data = args.data;
                switch (event) {
                    case "display-changed":
                        _this._registry.execute("on-display-changed", data.displays.map(_this.decorateDisplay));
                        break;
                    default:
                        _this._logger.warn("unknown event - " + event);
                        break;
                }
            });
        };
